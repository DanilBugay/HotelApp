...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-4 text_about_hotel">
            ...
            <p> Reasonable prices and flexible payment system, the high level of the number of rooms and a great
                location,
                make the hotel �Lighthouse� is equally attractive for both tourists and businessmen. </p>
            <p> No matter where you are - on a business trip or just a trip - a private hotel �Lighthouse� a worthy
                choice for you! </p>
        </div>
...
<div class="container">
    ...
    <div class="row rooms">
        <div class="col-lg-4">
            ...
            <h5 class="text_why">The entire summer season the hotel offers children and adult animation, evening
                shows.</h5>
        </div>
        <div class="col-lg-4">
            <img class="why_pict" src="images/14.jpg"/>
            <h5 class="text_why">Inside the hotel there are children's and adult swimming pools with heated seawater,
                saunas, tennis courts.</h5>
        </div>
        <div class="col-lg-4">
            <img class="why_pict" src="images/15.jpg"/>
            <h5 class="text_why">In the main building of the hotel is the cultural and Exhibition Center with its own
                concert hall for 500 persons.</h5>
        </div>
    </div>
...
<div class="container-fluid  booking rooms_2">
    <div class="row ">
        ...
        <div class="col-lg-4">
            <div class="bron">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/hotelCatalog" method="Get">
                    <div class="form-group">
                        <p class="header_book">MAKE A RESERVATION</p>
                        <label class="col-sm-3 control-label check">Check in:</label>
                        <div class="col-sm-9">
                            <input type="text" name="Date_start" class="form-control" id="datepicker"
                    ...
                    <div class="form-group inputs">
                        ...
                        <div class="col-sm-9">
                            <input name="Date_end" type="text" class="form-control" id="inputCheckOut"
                                   placeholder="26.06.2018">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" id="submit" name="submit_date" class="btn btn-default btn-block">Check
                        availability
                    </button>
                </form>
            </div>
