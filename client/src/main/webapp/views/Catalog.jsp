...
<c:if test="${aEMPTY_LIST == 1}">
    <form action="${pageContext.request.contextPath}/addCard" method="Get">
        <div class="container">
            <div class="row">
                <table border="1" class="table_catalog">
                    ...
                    <c:forEach var="room" items="${dataRoomCatalog}" varStatus="status">
                        <tr>
                            <td>${room.roomNum}</td>
                            ...
                            <td><input type="checkbox" name="selectroom" style="height: 100px; width: 100px;"
        ...
        <div class="container">
            <div class="row">
                <button type="submit" class="btn btn-primary button_add">Add to cart<i
                        class="fa fa-cart-arrow-down fa-lg icon_sign_up"></i></button>
            </div>
        </div>
    </form>
</c:if>
<c:if test="${aEMPTY_LIST == 0}">
    <div class="container">
        <div class="row">
