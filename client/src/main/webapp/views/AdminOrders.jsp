...
<html lang="ru">
    ...
    <body>
        ...
        <c:if test="${dataRoomHistory.size() > 0}">
            <form action="${pageContext.request.contextPath}/hotel/changeStatusOrder" method="POST">
                ...
                <div class="container">
                    <div class="row">
                        <table border="1" class="table_catalog">
                            ...
                            <c:forEach var="room" items="${dataRoomHistory}" varStatus="status">
                                <tr>
